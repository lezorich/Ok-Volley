package cl.lezorich.ok_volley.utils;
...
/**
 * Class that implements CookieStore interface. The cookie store saves to SharedPreferences the
 * session cookie.
 *
 * The cookie is saved serializing the cookie to a json string using gson.
 *
 * Created by lukas on 04-08-14.
 */
public class PersistentCookieStore implements CookieStore {
    ...
    public PersistentCookieStore(Context context) {
        ...
        if (!jsonSessionCookie.equals(PREF_SESSION_COOKIE)) {
